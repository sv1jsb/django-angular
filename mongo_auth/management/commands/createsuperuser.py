...
class Command(BaseCommand):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.username_field = self.UserModel._fields.get(self.UserModel.USERNAME_FIELD)
        ...
        if not options['interactive']:
            try:
                ...
                for field_name in self.UserModel.REQUIRED_FIELDS:
                    if options.get(field_name):
                        field = self.UserModel._fields.get(field_name)
                        field.validate(options[field_name])
            ...
            try:
                ...
                try:
                    ...
                    verbose_field_name = self.username_field.name
                while username is None:
                    ...
                    if not username:
                        continue
                    try:
                        self.UserModel.objects.get(**{self.UserModel.USERNAME_FIELD: username})
                ...
                for field_name in self.UserModel.REQUIRED_FIELDS:
                    ...
                    while user_data[field_name] is None:
                        message = force_str('%s: ' % capfirst(field.name))
